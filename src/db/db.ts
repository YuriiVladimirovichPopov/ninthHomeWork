...
export const blogsCollection = client
  .db()
  .collection<BlogsMongoDbType>("blogs");

export const postsCollection = client
  .db()
  .collection<PostsMongoDbType>("posts");

export const usersCollection = client
  .db()
  .collection<UsersMongoDbType>("users");

export const commentsCollection = client
  .db()
  .collection<CommentsMongoDbType>("comments");
...
export const deviceCollection = client
  .db()
  .collection<DeviceMongoDbType>("device");

export const rateLimitCollection = client
  .db()
  .collection<RateLimitMongoDbType>("rateLimit");
